...
var CloudflareMemStorage = class _CloudflareMemStorage {
  static {
    __name(this, "CloudflareMemStorage");
  }
...
var errorResponse = /* @__PURE__ */ __name((message, status = 500) => {
...
var routes2 = [
  // Get user by ID: GET /api/users/:id
  {
    method: "GET",
    path: "/api/users/:id",
    handler: /* @__PURE__ */ __name(async (context, params) => {
...
//# sourceMappingURL=functionsWorker-0.9189860945503252.mjs.map
